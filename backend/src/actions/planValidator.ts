import { ActionStep } from './executionState.js';
...
export class PlanValidator {
   ...
   */
  static validate(steps: any[]): ActionStep[] {
  ...
  private static validateStepSchema(step: any) {
  ...
  private static checkForRecursiveLoops(steps: ActionStep[]) {
