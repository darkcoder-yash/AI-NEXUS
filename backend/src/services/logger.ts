...
export class StructuredLogger {
  static info(message: string, userId?: string, requestId?: string, metadata: any = {}) {
    logger.info(message, { userId, requestId, metadata });
  }

  static warn(message: string, userId?: string, requestId?: string, metadata: any = {}) {
    logger.warn(message, { userId, requestId, metadata });
  }

  static error(message: string, userId?: string, requestId?: string, metadata: any = {}) {
  ...
  static logToolExecution(toolName: string, userId: string, requestId: string, duration: number, success: boolean, metadata: any = {}) {
  ...
  private static async persistErrorToDB(message: string, userId?: string, requestId?: string, metadata: any = {}) {
    try {
...
export class Logger {
  ...
  static async logAPIUsage(userId: string, provider: string, tokens: number) {
