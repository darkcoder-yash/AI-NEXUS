...
export class SecurityManager {
     ...
     */
    static async authorize(toolName, userId) {
    ...
    static logAction(toolName, userId) {
 ...
 */
export async function executeIntegratedTool(toolName, args, userId) {
    const tool = integrationRegistry[toolName];
    if (!tool)
        throw new Error(`Integration tool ${toolName} not found.`);
