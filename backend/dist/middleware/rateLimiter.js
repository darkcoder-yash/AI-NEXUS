...
export const globalRateLimiter = rateLimit({
    ...
    handler: (req, res, next, options) => {
        StructuredLogger.warn(`Rate limit exceeded for IP: ${req.ip}`, undefined, req.headers['x-request-id']);
...
export class ToolRateLimiter {
    static toolLimits = new Map();
    static check(toolName, userId, limit, windowMs = 60000) {
