...
export class MetricsService {
     ...
     */
    static async trackTokenUsage(userId, requestId, promptTokens, completionTokens, model) {
     ...
     */
    static async trackResponseTime(userId, requestId, durationMs, type) {
        try {
     ...
     */
    static async getUserMetricsAggregation(userId) {
